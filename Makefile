...
star1.bin: star1.o a_nasm.o api.ls
	gcc -m32 -march=i486 -nostdlib -fno-pic -T api.ls a_nasm.o star1.o -o star1.bin
...
haribote.img : ipl.bin hello.bin hello2.bin hello3.bin hello4.bin hello5.bin \
									winhello.bin win2.bin win3.bin star1.bin haribote.sys Makefile
	...
	mcopy star1.bin -i haribote.img ::
